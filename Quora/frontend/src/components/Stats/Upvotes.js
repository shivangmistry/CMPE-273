...
export class Upvotes extends Component {
    ...
    componentDidMount() {
        axios.get(rootUrl + "/user/" + Cookies.get('_id') + "/upvote_stats")
            .then((result) => {
                ...
                <Row>
                    ...
                    <Col sm={6} >
                        <PieChart width={400} height={400} >
                            <Pie dataKey="upvote" isAnimationActive={true} data={this.state.data} cx={200} cy={200} innerRadius={40} outerRadius={80} fill="#8884d8" label />
                            <Tooltip />
                        </PieChart>
                    </Col>
                </Row>
