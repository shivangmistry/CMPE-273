        ...
        return (
            <div className="navbar ">
                <header id="navigation-bar">
                    <ul className="navul">
                        <div>
                        <img src="https://28dvez1wnqjyd37ed3lq71f6-wpengine.netdna-ssl.com/wp-content/themes/twenty-seventeen-child/assets/images/sjsu-logo-gold.png" alt="logo" className="navbarlogo" />
                        </div><br />
